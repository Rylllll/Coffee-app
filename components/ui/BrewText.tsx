...
const variants: Record<BrewTextVariant, string> = {
  ...
  title:
    "text-[28px] font-black leading-[34px] tracking-[-1px] text-espresso dark:text-crema",
  ...
  caption:
    "text-xs font-semibold uppercase tracking-[1.6px] text-mocha/55 dark:text-crema/55",
  metric:
    "text-[32px] font-black tracking-[-1px] text-espresso dark:text-crema",
};
